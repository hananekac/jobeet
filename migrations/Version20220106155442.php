 ...
 */
final class Version20220106155442 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE affiliate ADD created_at DATETIME NOT NULL, ADD updated_at DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE affiliate DROP created_at, DROP updated_at');
