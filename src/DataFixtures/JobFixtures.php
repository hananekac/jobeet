...
class JobFixtures extends Fixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager): void
    {
        ...
        $jobSensioLabs->setCategory($this->getReference(CategoryFixtures::CATEGORY_PROGRAMMING));
        ...
        $jobExtremeSensio->setCategory($this->getReference(CategoryFixtures::CATEGORY_DESIGN));
